        ...
        <div>
          {Object.keys(con.cart).length == 0 ? (
            ...
            <div>
              ...
              <div className="max-w-2xl mx-auto pt-5 pb-2 px-4 sm:px-6 lg:max-w-7xl lg:pt-10 lg:pb-10 lg:px-8 lg:grid lg:grid-cols-6 lg:grid-rows-[auto,auto,1fr]">
                <div className="lg:max-w-7xl lg:pt-10 lg:pb-10 lg:px-8 lg:grid lg:grid-cols-2 lg:grid-rows-[auto,auto,1fr] p-5 lg:col-start-4 lg:col-span-2 flex flex-col bg-white rounded-md shadow-xl bg-gray-200">
