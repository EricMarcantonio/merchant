    ...
    <div className="bg-white shadow-lg overflow-hidden sm:rounded-lg">
      <div className="px-4 py-5 sm:px-6 border-t border-gray-200">
        <h3 className="text-lg leading-6 font-medium text-gray-900 justify-between flex">
          ...
          <div>
            <div className="text-xs sm:mt-0 sm:col-span-2 py-1 px-2.5 leading-none font-bold bg-yellow-500 text-white rounded">
        ...
        <dl>
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              {moment.utc(props.order.order.updatedAt).local().format("MMMM Do YYYY")}
            </dd>
          </div>
